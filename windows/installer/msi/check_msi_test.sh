...
fill() {
  sed -e "s|@VERSION@|1.0.0|g; s|@UPGRADECODE@|0F0E0D0C-0B0A-4908-8706-050403020100|g; s|@PRODUCTCODE@|*|g; s|@TIPDLL@|VietTelexTIP_1_0_0.dll|g; s|@FILEVERSION@|1.0.0.0|g" \
...
msibuild "$d/new.msi" -q "UPDATE \`File\` SET \`Language\`='1033' WHERE \`Version\`='1.0.0.0'"
python3 "$here/check_msi.py" --version 1.0.0.0 "$d/new.msi" >/dev/null
