...
const Pair kStrings[] = {
    ...
    {L"Hiện ở thanh tác vụ theo màu nền sáng/tối, và trong danh sách bàn phím (Win+Space) — đổi mục này cần quyền quản trị.",
     L"Shown on the taskbar (follows the light/dark taskbar) and in the keyboard list (Win+Space) — changing that one needs admin rights."},
    {L"Vᴛ", L"Vᴛ"},
    {L"Ngôi sao", L"Star"},
    ...
    {L"Không cần: thanh tác vụ đã hiện Việt/Anh. Mở lại Cài đặt bằng VietTelex trong menu Start.",
     L"Not needed: the taskbar already shows Vietnamese/English. Reopen Settings from VietTelex in the Start menu."},
    ...
    {L"Chế độ", L"Mode"},
    {L"Mặc định (composition)", L"Default (composition)"},
    {L"Sửa trực tiếp (in-place)", L"In-place"},
