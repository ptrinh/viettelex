...
const Pair kStrings[] = {
    ...
    {L"Tắt", L"Off"},
    {L"Biểu tượng", L"Icon"},
    {L"Biểu tượng trên thanh tác vụ, theo màu nền sáng/tối của Windows.",
     L"Taskbar icon; follows the light/dark taskbar."},
    {L"Vᴛ — mặc định", L"Vᴛ — default"},
    {L"★ — ngôi sao 5 cánh", L"★ — five-pointed star"},
    {L"Cờ Việt Nam", L"Vietnam flag"},
    {L"V / E (chữ)", L"V / E (letters)"},
